...
struct ICMPv6Packet: public PacketHeader {
    ...
    std::string to_string() const override {
        ...
        stream << "ICMPv6 Type: " << (int)type << std::endl;
        stream << "ICMPv6 Code: " << (int)code << std::endl;
    ...
    static ICMPv6Packet parse(const uint8_t *bytes, size_t length) {
